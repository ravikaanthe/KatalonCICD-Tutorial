...
WebUI.click(findTestObject('Object Repository/TestOpsIntegration/Page_CURA Healthcare Service/td_22'))

WebUI.click(findTestObject('Object Repository/TestOpsIntegration/Page_CURA Healthcare Service/input_Visit Date (Required)_visit_date'))
